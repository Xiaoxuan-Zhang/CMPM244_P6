...
def display_design_on_canvas(canvas, design):
    ...
    def draw_inspection_line(p1, p2, offset_obj=None, color_obj=None):
        i1, j1 = p1
        i2, j2 = p2
    ...
    def enter(event):
        ...
        try:
            analysis.inspect(ANALYSIS, coords, draw_inspection_line)
        except:
            print_exc()
    ...
    try:
        global ANALYSIS
        ANALYSIS = analysis.analyze(design)
    except:
        print_exc()
